import aboutMe from "@/assets/img/about/about-me.jpg";
import myCV from "@/assets/FPT_CV_ThiThanhTung_Developer.pdf";
const About = () => {
  return (
    <>
      {" "}
                ...
                <div className="leftbox">
                  ...
                  >
                    <div className="image layer" data-depth="0.1">
                      ...
                      <div className="inner" data-img-url={aboutMe}></div>
                    </div>
